...
summary(est_lms_2so)
#> 
#> modsem (1.0.13) ended normally after 81 iterations
#> 
#>   Estimator                                        LMS
...
#>   Loglikelihood                              -27008.82
#>   Akaike (AIC)                                54117.64
#>   Bayesian (BIC)                              54397.69
#>  
...
#>                                               Standard
#>   Chi-square                                     72.29
#>   Degrees of Freedom (Chi-square)                   70
#>   P-value (Chi-square)                           0.402
#>   RMSEA                                          0.004
#>                                                       
#>   Loglikelihood                              -27040.42
#>   Akaike (AIC)                                54178.83
#>   Bayesian (BIC)                              54453.28
#>  
#> Comparative Fit to H0 (LRT test):
#>   Loglikelihood change                           31.59
#>   Difference test (D)                            63.19
...
#>   ATT =~        
#>     att1            1.000                             
#>     att2            0.908      0.011   83.751    0.000
#>     att3            0.798      0.010   77.609    0.000
#>   SN =~         
#>     sn1             1.000                             
#>     sn2             0.909      0.016   55.183    0.000
#>     sn3             0.812      0.015   53.675    0.000
#>   PC =~         
#>     pc1             1.000                             
#>     pc2             0.890      0.010   89.848    0.000
#>     pc3             0.792      0.009   86.769    0.000
#>   PB =~         
#>     pb1             1.000                             
#>     pb2             0.918      0.012   77.219    0.000
#>     pb3             0.789      0.011   72.926    0.000
#>   BEH =~        
#>     b1              1.000                             
#>     b2              0.854      0.040   21.532    0.000
#>   INT =~        
#>     ATT             1.000                             
#>     SN              0.689      0.052   13.201    0.000
#>   PBC =~        
#>     PC              1.000                             
#>     PB              0.682      0.066   10.324    0.000
#> 
#> Regressions:
#>                  Estimate  Std.Error  z.value  P(>|z|)
#>   BEH ~         
#>     INT             0.201      0.022    8.983    0.000
#>     PBC             0.207      0.024    8.517    0.000
#>     INT:PBC         0.166      0.024    6.765    0.000
#> 
#> Intercepts:
#>                  Estimate  Std.Error  z.value  P(>|z|)
#>    .pb1             1.009      0.026   38.545    0.000
#>    .pb2             1.013      0.024   41.333    0.000
#>    .pb3             1.014      0.021   47.265    0.000
#>    .pc1             1.030      0.031   33.689    0.000
#>    .pc2             1.021      0.028   37.080    0.000
#>    .pc3             1.025      0.025   41.517    0.000
#>    .sn1             0.979      0.021   47.127    0.000
#>    .sn2             0.985      0.019   50.748    0.000
#>    .sn3             0.992      0.018   56.131    0.000
#>    .att1            1.007      0.028   36.008    0.000
#>    .att2            1.000      0.026   39.197    0.000
#>    .att3            1.011      0.023   44.041    0.000
#>    .b1              0.994      0.020   49.921    0.000
#>    .b2              0.991      0.018   54.328    0.000
#> 
#> Covariances:
#>                  Estimate  Std.Error  z.value  P(>|z|)
#>   INT ~~        
#>     PBC             0.033      0.032    1.028    0.304
#> 
#> Variances:
#>                  Estimate  Std.Error  z.value  P(>|z|)
#>    .pb1             0.146      0.009   16.819    0.000
#>    .pb2             0.168      0.008   20.525    0.000
#>    .pb3             0.159      0.007   23.228    0.000
#>    .pc1             0.165      0.009   17.766    0.000
#>    .pc2             0.166      0.008   20.690    0.000
#>    .pc3             0.150      0.007   22.120    0.000
#>    .sn1             0.158      0.008   18.659    0.000
#>    .sn2             0.172      0.008   21.676    0.000
#>    .sn3             0.160      0.007   23.245    0.000
#>    .att1            0.163      0.009   18.444    0.000
#>    .att2            0.150      0.008   19.719    0.000
#>    .att3            0.161      0.007   23.345    0.000
#>    .b1              0.136      0.029    4.668    0.000
#>    .b2              0.187      0.022    8.547    0.000
#>    .ATT             0.370      0.075    4.905    0.000
#>    .SN              0.215      0.037    5.898    0.000
#>    .PC              0.526      0.111    4.729    0.000
#>    .PB              0.675      0.057   11.814    0.000
#>    .BEH             0.537      0.034   16.011    0.000
#>     INT             1.030      0.088   11.749    0.000
#>     PBC             1.178      0.122    9.643    0.000
```
...
summary(est_lms_1so)
#> 
#> modsem (1.0.13) ended normally after 37 iterations
#> 
#>   Estimator                                        LMS
#>   Optimization method                       EMA-NLMINB
...
#>  
#> Loglikelihood and Information Criteria:
#>   Loglikelihood                              -19992.75
#>   Akaike (AIC)                                40063.51
#>   Bayesian (BIC)                              40281.94
#>  
#> Numerical Integration:
...
#>                                               Standard
#>   Chi-square                                     36.85
#>   Degrees of Freedom (Chi-square)                   39
#>   P-value (Chi-square)                           0.568
#>   RMSEA                                          0.000
#>                                                       
#>   Loglikelihood                              -20090.84
#>   Akaike (AIC)                                40257.68
#>   Bayesian (BIC)                              40470.51
#>  
#> Comparative Fit to H0 (LRT test):
#>   Loglikelihood change                           98.08
#>   Difference test (D)                           196.17
#>   Degrees of freedom (D)                             1
#>   P-value (D)                                    0.000
#>  
#> R-Squared Interaction Model (H1):
...
#>   ATT =~        
#>     att1            1.000                             
#>     att2            0.909      0.011   82.790    0.000
#>     att3            0.802      0.010   80.441    0.000
#>   PBC =~        
#>     pbc1            1.000                             
#>     pbc2            0.911      0.014   66.996    0.000
#>     pbc3            0.794      0.013   63.462    0.000
#>   SN =~         
#>     sn1             1.000                             
#>     sn2             0.890      0.016   54.353    0.000
#>     sn3             0.790      0.015   52.226    0.000
#>   BEH =~        
#>     b1              1.000                             
#>     b2              0.863      0.028   30.548    0.000
#>   INT =~        
#>     ATT             1.000                             
#>     PBC             0.818      0.024   34.100    0.000
#>     SN              0.702      0.021   33.589    0.000
#> 
#> Regressions:
#>                  Estimate  Std.Error  z.value  P(>|z|)
#>   BEH ~         
#>     PBC             0.187      0.044    4.295    0.000
#>     INT             0.189      0.045    4.166    0.000
#>     INT:PBC         0.215      0.016   13.462    0.000
#> 
#> Intercepts:
#>                  Estimate  Std.Error  z.value  P(>|z|)
#>    .sn1             0.972      0.021   46.863    0.000
#>    .sn2             0.980      0.019   51.980    0.000
#>    .sn3             0.990      0.017   58.056    0.000
#>    .pbc1            0.982      0.024   41.323    0.000
#>    .pbc2            0.986      0.022   44.854    0.000
#>    .pbc3            0.996      0.020   50.888    0.000
#>    .att1            0.999      0.028   36.060    0.000
#>    .att2            1.006      0.026   39.309    0.000
#>    .att3            1.000      0.023   43.900    0.000
#>    .b1              0.974      0.023   41.551    0.000
#>    .b2              0.980      0.021   45.970    0.000
#> 
#> Variances:
#>                  Estimate  Std.Error  z.value  P(>|z|)
#>    .sn1             0.171      0.009   19.832    0.000
#>    .sn2             0.165      0.007   21.949    0.000
#>    .sn3             0.151      0.006   23.252    0.000
#>    .pbc1            0.163      0.009   19.103    0.000
#>    .pbc2            0.166      0.008   21.349    0.000
#>    .pbc3            0.159      0.007   23.550    0.000
#>    .att1            0.152      0.008   18.227    0.000
#>    .att2            0.168      0.008   21.497    0.000
#>    .att3            0.147      0.006   22.712    0.000
#>    .b1              0.144      0.021    6.816    0.000
#>    .b2              0.181      0.016   11.075    0.000
#>    .ATT             0.389      0.024   15.916    0.000
#>    .PBC             0.300      0.018   16.415    0.000
#>    .SN              0.199      0.013   14.886    0.000
#>    .BEH             0.516      0.026   19.526    0.000
#>     INT             0.994      0.025   40.310    0.000
```
...
#>   BEH                                            0.165 
#> 
#> lavaan 0.6-19 ended normally after 614 iterations
#> 
#>   Estimator                                         ML
...
#>     a      (l_3_A)    0.787    0.009   89.748    0.000
#>   SN =~                                               
#>     s      (l_1_S)    1.000                           
...
#>   PC =~                                               
#>     p     (l_1_PC)    1.000                           
#>     p     (l_2_PC)    0.889    0.009  101.652    0.000
#>     p     (l_3_PC)    0.787    0.008   97.812    0.000
#>   BEH =~                                              
#>     b      (l_1_B)    1.000                           
...
#>     S     (l_SNPC)    0.729    0.031   23.235    0.000
#>     S     (l_SNPB)    0.606    0.027   22.365    0.000
#>   ATTPC =~                                            
#>     a (l_11_ATTPC)    1.000                           
#>     a (l_22_ATTPC)    0.803    0.009   90.730    0.000
#>     a (l_33_ATTPC)    0.620    0.007   86.179    0.000
#>   ATTPB =~                                            
#>     a (l_11_ATTPB)    1.000                           
#>     a (l_22_ATTPB)    0.834    0.010   83.614    0.000
#>     a (l_33_ATTPB)    0.622    0.008   78.870    0.000
#>   SNPC =~                                             
#>     s  (l_11_SNPC)    1.000                           
...
#> Variances:
#>                    Estimate  Std.Err  z-value  P(>|z|)
#>    .AT    (Vr_ATT)    0.306    0.088    3.483    0.000
...
#>     IN    (V_INTP)    1.297    0.089   14.647    0.000
...
#>   BEH                                            0.182 
#> 
#> lavaan 0.6-19 ended normally after 762 iterations
#> 
#>   Estimator                                         ML
#>   Optimization method                           NLMINB
...
#>    .sn3pc1            0.087    0.005   15.974    0.000
#>  .sn2pc2 ~~                                           
#>    .sn2pc3            0.209    0.010   20.438    0.000
...
#>    .att3pb2           0.367    0.012   29.700    0.000
...
#>    .sn1pb2            0.291    0.012   24.574    0.000
...
#>   BEH                                            0.232 
#> 
#> lavaan 0.6-19 ended normally after 442 iterations
#> 
#>   Estimator                                         ML
#>   Optimization method                           NLMINB
...
#>   ATTPBC =~                                           
#>     att11 (l_11_A)    1.000                           
#>     att22 (l_22_A)    0.813    0.009   87.005    0.000
...
#>                    Estimate  Std.Err  z-value  P(>|z|)
#>   INT ~~                                              
#>     INTxPBC (C_IN)   -0.019    0.025   -0.759    0.448
#>  .att1pbc1 ~~                                         
#>    .att2pb2           0.000                           
#>    .att3pb3           0.000                           
#>  .att2pbc2 ~~                                         
...
#>    .SNPBC   (M_SN)    0.302    0.010   30.548    0.000
#>    .PBCPBC  (M_PB)    0.575    0.011   51.527    0.000
...
#>    .sn1p1 (Vr_s11)    0.279    0.008   35.024    0.000
...
#>   BEH                                            0.276 
#> 
#> lavaan 0.6-19 ended normally after 562 iterations
#> 
#>   Estimator                                         ML
#>   Optimization method                           NLMINB
...
#>  .sn3pbc3 ~~                                          
#>    .pbc3pbc1          0.079    0.005   16.646    0.000
#>  .pbc3pbc2 ~~                                         
