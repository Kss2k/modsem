...
The `rcs.res.cov.xz` argument should be used when using one of the PI approaches (excluding
the constrained approach) to apply reliability corrections to the generated product
indicators (created from reliability-corrected single-items) as well.
