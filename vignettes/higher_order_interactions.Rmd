...
high standard errors. Possible due to the fact that higher order interactions
do not fit the model, or that it is too unstable to estimate. It might be better 
to use the constrained or unconstrained approach to estimate the interactions
but they are not yet well suited for calculating constraints with higher order
constructs.
