...
where $\bm{Az}$ is the expected value of $X$ at quadrature point `k`, and 
...
have to specify a measurement error for moderating variables. The only 
restriction in the QML approach, is that all endogenous variables have 
