...
QuadGrid2XPtr <- function(quadR) {
    .Call(`_modsem_QuadGrid2XPtr`, quadR)
}

completeLogLikLmsCpp <- function(modelR, data, xpCache) {
    .Call(`_modsem_completeLogLikLmsCpp`, modelR, data, xpCache)
}

obsLogLikLmsCpp <- function(modelR, data, quadR) {
    .Call(`_modsem_obsLogLikLmsCpp`, modelR, data, quadR)
}
